                        ...
                        >
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-4 gap-2">
                            ...
                            <div>
                              ...
                              {/* type="text" + inputMode="numeric" em vez de
                                  type="number": tira as setinhas de incremento
                                  (em tela de toque sem teclado elas viravam o
                                  unico jeito de preencher), abre o teclado
                                  numerico no tablet e impede a rodinha do mouse
                                  de alterar o valor sem querer. So digito entra;
                                  tocar no campo ja seleciona o que estava la. */}
                              <input
                                type="text"
                                inputMode="numeric"
                                pattern="[0-9]*"
                                ...
                                onChange={(e) =>
                                  updateForm(item.id, 'quantity', e.target.value.replace(/\D/g, ''))
                                }
