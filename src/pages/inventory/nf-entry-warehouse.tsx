...
export function NfEntryWarehouse() {
  ...
  function addLine(item: ItemRow) {
    ...
    // LOTE. A RPC trata cada linha de forma independente e cria o lote por
    // (item, lote, local). No Almoxarifado segue valendo um item por entrada.
          ...
          {search.trim() && (
            <div className="absolute z-20 w-full mt-1 bg-white border border-gray-200 rounded-lg shadow-lg max-h-64 overflow-y-auto">
              {searching ? (
                ...
                // Almox bloqueia item repetido; Satelite Terreo nao, porque
                // cada linha e um lote diferente.
